...
import (
	...
	"github.com/Airi-hub/mecari-build-hackathon-2023/backend/db"
	"github.com/Airi-hub/mecari-build-hackathon-2023/backend/handler"
...
func run(ctx context.Context) int {
	...
	e.GET("/category/:categoryID", h.GetCategoryItem)
